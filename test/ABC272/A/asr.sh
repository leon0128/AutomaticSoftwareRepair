...
## general
EXECUTION_NAME="./asr"
TARGET_FILENAME="test/ABC272/A/WA/35469736.c"
TARGET_FUNCTIONS=()
EXTERNAL_PATHS=("test/ABC272/A/AC/")
RESULT_FILENAME="test/ABC272/A/result.c"

EXEC_EXTENSION=""
NULL_FILENAME="/dev/null"

## test case
TEST_SCRIPT_FILENAME="test/testcase.sh"
POSITIVE_PREFIX="p"
NEGATIVE_PREFIX="n"
