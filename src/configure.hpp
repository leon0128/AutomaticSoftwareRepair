...
#define GET_SAFELY(objectName) \
    ...
    inline static bool SHOULD_OUTPUT_ANALYZE_LOG;
    GET_SAFELY(SHOULD_OUTPUT_ANALYZE_LOG)
    inline static bool SHOULD_OUTPUT_SIMILARITY_LOG;
    GET_SAFELY(SHOULD_OUTPUT_SIMILARITY_LOG)
