...
std::optional<std::size_t> Register::registerStatement(TOKEN::Statement *statement)
{
    ...
    statement->statementId = ANALYZER::Analyzer::addStatement(std::shared_ptr<Statement>(statement->copy()));
...
std::optional<std::size_t> Register::registerDeclaration(TOKEN::Declaration *declaration)
{
    ...
    declaration->statementId = ANALYZER::Analyzer::addStatement(std::shared_ptr<Declaration>(declaration->copy()));
